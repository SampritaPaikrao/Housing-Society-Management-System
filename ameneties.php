...
<input type="checkbox" id="check">
    ...
    <div class="sidebar">
      ...
      <a href="ameneties.php"class="active"><i class="fas fa-desktop"></i><span>Ameneties Booking</span></a>
  ...
  <?php
    ...
    <tr>
      ...
      <form action="updateuser.php" method="post">
        ...
        <td><input type="submit" name="edit" class="Table_btn" value="Booked"> </td>
      </form>
